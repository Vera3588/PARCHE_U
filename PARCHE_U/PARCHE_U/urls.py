...
urlpatterns = [
    ...
    path('', views.logout_request ,name ='cerrar_sesion'),
    ...
    path('inicioPsicologo/', views.InicioPsicologos, name='inicio_psicologos'),
    path('saltoiniPsicologo/', views.SaltoInicioPsicologos, name='salto_ini_psicologos'),
